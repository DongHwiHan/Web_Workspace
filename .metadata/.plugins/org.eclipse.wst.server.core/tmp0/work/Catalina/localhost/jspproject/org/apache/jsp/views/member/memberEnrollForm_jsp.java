 ...
 * Generated at: 2023-03-06 03:18:58 UTC
...
public final class memberEnrollForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/member/../common/menubar.jsp", Long.valueOf(1677197515172L));
  }
 ...
 if(loginUser == null) {
      ...
      out.write("	            \r\n");
      out.write("	            <div align=\"center\">\r\n");
      out.write("	            	<button type=\"submit\" id=\"target_btn\" disabled>회원가입</button>\r\n");
      ...
      out.write("			\r\n");
      out.write("			//const $userId = $(\"rnroll-form [name=userId]\");  // 강사님 버전\r\n");
      out.write("			// name이 userId인 요소가 menubar.jsp에서도 존재하므로, 확실하게 어디에 속해있는지 잘 적워줘야한다.\r\n");
      out.write("			\r\n");
      out.write("			\r\n");
      ...
      out.write("						\r\n");
      out.write("					// 사용가능한경우\r\n");
      out.write("						confirm(\"사용가능한 아이디 입니다. 사용 하시겠습니까?\")\r\n");
      out.write("						// 아이디값 수정할수 없게막기\r\n");
      out.write("						//userId.attr(\"readonly\",true); // 아이디값 확정\r\n");
      out.write("						// 회원가입 버튼 활성화\r\n");
      out.write("						//$(\"#enroll-form : submit\").removeAttr(\"disabled\"); // 회원가입버튼 활성화 // 강사님 버전\r\n");
      out.write("						const target = document.getElementById(\"target_btn\");\r\n");
