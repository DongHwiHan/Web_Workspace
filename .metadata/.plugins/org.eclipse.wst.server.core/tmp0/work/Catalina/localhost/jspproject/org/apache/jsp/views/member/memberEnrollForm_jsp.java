 ...
 * Generated at: 2023-04-06 09:41:01 UTC
...
public final class memberEnrollForm_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginUser == null) { 
      ...
      out.write("	            	<button type=\"reset\" onclick=\"hrefLink();\">초기화</button>\r\n");
      out.write("	            </div>\r\n");
      out.write("	            <br><br>\r\n");
      out.write("		</form>\r\n");
      out.write("	\r\n");
      ...
      out.write("			// name이 uesrId인 요소가 menubar.jsp에서도 존재하므로, 확실하게 어디에속해있는지 잘 적어줘야한다.\r\n");
      out.write("			\r\n");
      ...
      out.write("					}else{\r\n");
      out.write("						// 사용가능한경우\r\n");
      out.write("						if(confirm(\"사용가능한 아이디 입니다. 사용 하시겠습니까?\")){\r\n");
      out.write("							// 아이디값 수정할수 없게 막기\r\n");
      out.write("							$userId.attr(\"readonly\",true);//아이디값 확정\r\n");
      out.write("							// 회원가입 버튼 활성화\r\n");
      out.write("							$(\"#enroll-form :submit\").removeAttr(\"disabled\");// 회원가입버튼 활성화				\r\n");
      out.write("						}else{ // 사용안함 \r\n");
