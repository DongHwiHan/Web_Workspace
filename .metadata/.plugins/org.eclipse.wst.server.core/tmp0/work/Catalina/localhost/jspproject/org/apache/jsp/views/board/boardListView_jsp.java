 ...
 * Generated at: 2023-02-24 00:13:58 UTC
...
public final class boardListView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/board/../common/menubar.jsp", Long.valueOf(1677197515172L));
  }
 ...
 for(Board b  :  list) { 
      ...
      out.write("					\r\n");
      out.write("					// 클릭시 해당 공지사항의 글번호를 알와야함.\r\n");
      out.write("					// tr요소의 자손중에서 첫번째 td태그의 영역안의 내용을 가져올 예정\r\n");
      out.write("					\r\n");
      out.write("					let bno = $(this).children().eq(0).text();\r\n");
      out.write("					//현재 내가 클릭한 tr의 자손들중 0번째에 위치한 자식의 textNode값을 가져온다.\r\n");
      out.write("					\r\n");
      out.write("					//요청할 url?키=밸류&키=밸류\r\n");
      out.write("					// 물음표 뒤의 내용을 쿼리스트링이라고 부름 => 직접 만들어서 넘겨줘야한다.\r\n");
      out.write("					location.href = '");
      out.print( contextPath );
