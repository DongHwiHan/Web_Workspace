		...
		<form id="mypage-form" action="<%= contextPath %>/update.me" method="post">
		  ...
		  <!-- 아이디, 비밀번호, 이름, 전화번호, 이메일, 주소, 취미 -->
            ...
            <script>
            	$(function(){
            		...
            		$("input[name='interest']").each(function(){
            			...
            			// 포함되어있다면 혀재 접근한 input요소의 checked속성을 부여.
            			if( interest.search( $(this).val()) >=0  ){ // interest 문자열로부터 현재 체크박스의 value가 포함되어잇는지 확인
            ...
            <div align="center">
            	...
            	비밀번호 변경</button>
            	<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteForm">
            	회원탈퇴</button>
            </div>
			<br><br>
	</form>
