...
public class MemberInsertController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String phone = request.getParameter("phone");// 빈문자열이 널값으로 전달될수있음
		String email = request.getParameter("email");// 빈문자열이 널값으로 전달될수있음
		String address = request.getParameter("address"); // 빈문자열이 널값으로 전달될수있음
