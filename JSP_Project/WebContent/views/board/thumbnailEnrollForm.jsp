	...
	<div class="outer">
		...
		<form action="<%=contextPath%>/insert.th" id="enroll-form"
			...
			<table align="center">
				<tr>
					<th width="100">제목</th>
					<th colspan="3"><input type="text" name="title" required></th>
				</tr>
				<tr>
					<th>내용</th>
