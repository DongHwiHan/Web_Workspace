...
<body>
	...
	<p>
		...
		&lt;fmt:formatNumber value="출력할값" groupingUsed="true/false" type="percent/currency" currencySymbol="$" /&gt;<br>
	</p>
	...
	<!-- 
		3자리수마다 ,가 찍히게하고 싶으면 groupingUsed속성을 true로 부여하면됨(기본값 true, 생략가능)
	 -->
	...
	<!-- 
		currency : 통화(돈)단위로 보여짐. 현재 내 컴퓨터의 로컬정보에따라 통화기호가 결정됨
	 ...
	 <ul>
	 	...
	 	<li>
	 		현재 시간 : <fmt:formatDate value="${current }" type="both"/>
	 	</li>
